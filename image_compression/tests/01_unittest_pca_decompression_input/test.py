...
def test_pca_decompression_1():
    ...
    # Ответ old_true_answer неверный
    # Но оставлен, чтобы тем, кто уже успел сделать задание, не пришлось его переделывать
    old_true_answer = np.array([[[226, 222, 221], [218, 214, 208], [212, 209, 201], [201, 192, 189], [198, 193, 193], [206, 210, 209], [208, 212, 207],[205, 196, 192], [216, 207, 205], [236, 234, 234]],
        [[224, 227, 226], [217, 220, 216], [210, 212, 207], [196, 202, 200], [191, 195, 195], [201, 199, 198], [206, 204, 201], [204, 210, 207], [217, 223, 221], [240, 241, 242]],
        [[234, 229, 227], [224, 219, 211], [206, 202, 192], [217, 207, 203], [227, 221, 221], [232, 236, 234], [232, 236, 230], [229, 219, 214], [220, 210, 207], [207, 205, 205]],
        [[231, 236, 231], [222, 227, 210], [203, 207, 187], [207, 217, 210], [214, 220, 221], [222, 218, 215], [227, 223, 211], [226, 236, 225], [221, 231, 226], [216, 218, 218]],
        [[231, 227, 229], [222, 219, 225], [192, 189, 196], [187, 179, 182], [191, 186, 186], [207, 210, 212], [220, 223, 227], [226, 219, 223], [226, 219, 220], [230, 229, 228]],
        [[227, 232, 236], [221, 226, 238], [199, 203, 218], [199, 211, 216], [204, 211, 210], [215, 211, 213], [225, 220, 230], [226, 236, 245], [224, 235, 238], [223, 225, 224]],
        [[221, 227, 228], [216, 221, 225], [224, 228, 234], [224, 236, 238], [225, 232, 232], [223, 218, 219], [218, 214, 217], [205, 216, 219], [212, 223, 224], [221, 222, 222]],
        [[248, 244, 246], [228, 224, 234], [217, 213, 225], [218, 208, 212], [222, 216, 215], [227, 230, 232], [214, 218, 225], [211, 201, 208], [208, 199, 202], [216, 214, 214]],
        [[227, 232, 232], [221, 225, 226], [205, 209, 210], [217, 227, 228], [228, 234, 234], [231, 227, 227], [235, 232, 232], [231, 241, 241], [222, 232, 232], [207, 208, 208]],
        [[223, 224, 223], [216, 217, 214], [223, 224, 220], [219, 222, 220], [218, 219, 219], [218, 217, 216], [213, 212, 210], [202, 204, 202], [211, 214, 213], [226, 226, 226]]
    ])
    ...
    assert np.max(np.abs(answer - true_answer)) <= 2 or np.max(np.abs(answer - old_true_answer)) <= 2
...
def test_pca_decompression_2():
    ...
    # Ответ old_true_answer неверный
    # Но оставлен, чтобы тем, кто уже успел сделать задание, не пришлось его переделывать
    old_true_answer = np.load('old_1.npy')
